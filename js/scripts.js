...
var closeAlerts, closeMenu, equidist, formValidation, fvInput, fvInputMessage, isMobile, openAlert, openMenu, popupWindow, scrolls, setScroll, validarEmail, _in, _out;
...
openMenu = function() {
  ...
  return $(".responsive-menu").addClass("active");
};
...
closeMenu = function() {
  ...
  return setTimeout(function() {
    return $(".responsive-menu").removeClass("active out");
  }, 500);
};
